...
- Preallocate waveform output when its size is known, reduce peak-generation
  allocations, and avoid PCM conversion during the counting pass. Extend installed
  native-gem smoke checks to points, bits, and duration.
