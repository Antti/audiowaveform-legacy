...
| ----------- | ------ | ---------------------------------------- |
| 24          | int8_t | Minimum sample value, index 0, channel 0 |
| 25          | int8_t | Maximum sample value, index 0, channel 0 |
| 26          | int8_t | Minimum sample value, index 0, channel 1 |
| 27          | int8_t | Maximum sample value, index 0, channel 1 |
| 28          | int8_t | Minimum sample value, index 1, channel 0 |
| 29          | int8_t | Maximum sample value, index 1, channel 0 |
| 30          | int8_t | Minimum sample value, index 1, channel 1 |
| 31          | int8_t | Maximum sample value, index 1, channel 1 |
| etc         | ...    | ...                                      |
...
| Byte offset | Type    | Value                                    |
| ----------- | ------- | ---------------------------------------- |
| 24-25       | int16_t | Minimum sample value, index 0, channel 0 |
| 26-27       | int16_t | Maximum sample value, index 0, channel 0 |
| 28-29       | int16_t | Minimum sample value, index 0, channel 1 |
| 30-31       | int16_t | Maximum sample value, index 0, channel 1 |
| 32-33       | int16_t | Minimum sample value, index 1, channel 0 |
| 34-35       | int16_t | Maximum sample value, index 1, channel 0 |
| 36-37       | int16_t | Minimum sample value, index 1, channel 1 |
| 38-39       | int16_t | Maximum sample value, index 1, channel 1 |
| etc         | ...     | ...                                      |
